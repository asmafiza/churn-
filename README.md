...
This repository contains an end-to-end Machine Learning and Exploratory Data Analysis (EDA) pipeline designed to predict customer churn using the Kaggle Telco Customer Churn dataset. It features data engineering, correlation analysis, and benchmarking of several classification models to detect customer attrition.

## 📌 Project Overview
Customer churn happens when customers stop doing business with a company. Discovering why customers leave and predicting who is at risk allows telecom operators to proactively implement retention strategies.
